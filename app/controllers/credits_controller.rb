class CreditsController < ApplicationController
  ...
  def summary
    @credit_transactions = Credit.where(:id => params[:credit_id]).first.cashbooks
    #@debit_transactions = Debit.where(:id => params[:credit_id]).first.cashbooks
  end
